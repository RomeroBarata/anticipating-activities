...
from utils.helper_functions import filter_lists, write_step_predictions
...
parser.add_argument("--input_type", default="decoded", help="select input type: [\"decoded\", \"gt\", \"fisher\"]")
        ...
        for vid in list_of_videos:
            ...
            for obs_p in obs_percentages:
                ...
                for pred_p in pred_percentages:
                    ...
                    with tf.Session() as sess:
                        label_seq, length_seq = model.predict(sess, model_restore_path, pred_len, label_seq,
